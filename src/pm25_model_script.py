"""
Predict concentration level of pm2.5.
...
print(df.shape) #407,400
print(df_overall.shape) #353,196
...
# X shape: (22040, 50)
# y shape: (22040,)
X_sample = X_rfe.sample(frac=.15, random_state=random_state, weights=sample_weights)
y_sample = y[y.index.isin(X_sample.index)].reindex(X_sample.index)

print('X_sample shape:', X_sample.shape)
print('y_sample shape:', y_sample.shape)
# X_sample shape: (3306, 50)
# y_sample shape: (3306,)
#%%
param = {
    'learning_rate': [.1]
...
# time of gridsearch: 34.89
# best params: {'booster': 'gbtree', 'colsample_bytree': 0.6, 'learning_rate': 0.1, 'max_depth': 5, 'min_child_weight': 30, 'n_estimators': 400, 'reg_alpha': 0.5, 'reg_lambda': 0.3, 'subsample': 0.3}
# best train score: 0.9928551292364709
# best train std: 0.0007042238399139934
# best test score: 0.948904136889914
# best test std: 0.008560513667283227
...
updated_dict['colsample_bytree'] = .5
...
# train mean of r2: 0.9689893506599279
# train std of r2: 0.0005992891008982948
# test mean of r2: 0.9532269389975174
# test std of r2: 0.0014396053737247318
# train mean of smape: 0.16384903093986272
# train std of smape: 0.002759972788710728
# test mean of smape: 0.17876426748418264
# test std of smape: 0.006066998887226157
