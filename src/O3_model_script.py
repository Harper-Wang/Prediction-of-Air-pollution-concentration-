#%%
"""
Predict concentration level of O3.
...
df= df[df['utc_time'] >= str(datetime.datetime(2018, 4, 1, 0, 0))]
...
#%%
feature_table_rfe[1]['final_number'] = 60
...
# time of gridsearch: 242.87
# best params: {'booster': 'gbtree', 'colsample_bytree': 0.66, 'learning_rate': 0.1, 'max_depth': 5, 'min_child_weight': 25, 'n_estimators': 400, 'reg_alpha': 0.4, 'reg_lambda': 0.2, 'subsample': 0.5}
# best train score: 0.9913308583585506
# best train std: 0.0002789405647831783
# best test score: 0.9499261969086541
# best test std: 0.0012937165778542745
#%%
xgbr = XGBRegressor(
    random_state=model_random_state
    , n_jobs=-1
